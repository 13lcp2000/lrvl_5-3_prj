...
<html>
<head>
<title>Cinema A Entertainment Category Flat Bootstarp Resposive Website Template | resenias :: w3layouts</title>
...
<body>
	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a class="active" href="resenias.html"><div class="cat"><i class="watching"></i><i class="watching1"></i></div></a></li>
					<li><a href="contacto.html"><div class="cnt"><i class="contacto"></i><i class="contacto1"></i></div></a></li>
				</ul>
			</div>
		<div class="main">
		<div class="review-content">
			...
			<div class="resenias-section">
				<h3 class="head">Pelicula resenias</h3>
					<div class="col-md-9 resenias-grids">
						<div class="review">
							<div class="Pelicula-pic">
								<a href="single.html"><img src="images/r4.jpg" alt="" /></a>
							</div>
							<div class="review-info">
								<a class="span" href="single.html">Lorem  <i>Pelicula Review</i></a>
					...
					<div class="col-md-3 side-bar">
						<div class="featured">
							<h3>Featured Today in Pelicula resenias</h3>
							<ul>
								<li>
									<a href="single.html"><img src="images/f1.jpg" alt="" /></a>
									<p>lorem Pelicula review</p>
								</li>
								<li>
	...
	<div class="footer">
		<h6>Disclaimer : </h6>
		<p class="claim">This is a freebies and not an official website, I have no intention of disclose any Pelicula, brand, news.My goal here is to train or excercise my skill and share this freebies.</p>
